class Mesh {
    int NUM_VBOS=3;
    ArrayList<Vector3> verts=new ArrayList<Vector3>(); //儲存頂點
    ArrayList<Vector3> uvs=new ArrayList<Vector3>();   //UV 坐標
    ArrayList<Vector3> normals=new ArrayList<Vector3>();//法向量
    ArrayList<Triangle> triangles=new ArrayList<Triangle>();//切線
    ArrayList<Vector4> tangents=new ArrayList<Vector4>(); //三角形資訊
